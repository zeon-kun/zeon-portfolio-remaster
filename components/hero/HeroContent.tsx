...
import { Cat, Code2, Coffee, Mail } from "lucide-react";
...
/** @deprecated Use HeroSlide from components/slides instead */
    ...
    <>
      ...
      >
        <div className="flex-1 flex flex-col justify-center max-w-4xl">
          <div className="space-y-2">
            <div className="overflow-hidden">
              <h1
                data-hero-kanji
                translate="no"
                className="text-[clamp(5rem,20vw,16rem)] font-black leading-[0.85] kanji-brutal text-foreground"
              >
                路四
              </h1>
            </div>
          ...
          <div className="mt-12 flex flex-col md:flex-row md:items-start md:justify-between gap-8 max-w-3xl pl-2">
            <div data-hero-meta className="space-y-2">
              ...
              <p className="text-sm text-muted font-medium tracking-wide">Based Remotely</p>
            </div>
        ...
        <div className="flex flex-col md:flex-row md:items-center gap-6 max-w-4xl pl-2">
          <p data-hero-meta className="text-xs font-mono text-muted uppercase tracking-widest whitespace-nowrap">
            <div
              data-hero-meta
